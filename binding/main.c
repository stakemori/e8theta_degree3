                      ...
                      if (inner_prod(vs2[j], vs3[k]) == d)
                        {
                          ...
                          fmpz_zero(a0);
                          fmpz_submul_ui(a0, s1, 2);
                          fmpz_zero(a1);
                          fmpz_addmul_ui(a1, s2, 2);
                          fmpz_zero(a2);
                          fmpz_submul_ui(a2, s4, 2);
                          fmpz_zero(a3);
                          fmpz_addmul_ui(a3, s5, 2);
                          fmpz_mul(a3, a3, t1);
                          fmpz_addmul(a3, a2, t2);
                          fmpz_addmul(a3, a1, t4);
                          fmpz_addmul(a3, a0, t5);
                          fmpz_zero(a0);
                          fmpz_addmul_ui(a0, s1, 2);
                          fmpz_zero(a1);
                          fmpz_submul_ui(a1, s2, 2);
                          fmpz_zero(a2);
                          fmpz_addmul_ui(a2, s4, 2);
                          fmpz_zero(a4);
                          fmpz_submul_ui(a4, s5, 2);
                          fmpz_mul(a4, a4, u1);
                          fmpz_addmul(a4, a2, u2);
                          fmpz_addmul(a4, a1, u4);
                          fmpz_addmul(a4, a0, u5);
                          fmpz_zero(a0);
                          fmpz_submul_ui(a0, t1, 2);
                          fmpz_zero(a1);
                          fmpz_addmul_ui(a1, t2, 2);
                          fmpz_zero(a2);
                          fmpz_submul_ui(a2, t4, 2);
                          fmpz_zero(a8);
                          fmpz_addmul_ui(a8, t5, 2);
                          fmpz_mul(a8, a8, u1);
                          ...
                          fmpz_addmul(a7, a0, u3);
                          fmpz_zero(a0);
                          fmpz_submul_ui(a0, s4, 2);
                          fmpz_zero(a1);
                          fmpz_addmul_ui(a1, s5, 2);
                          fmpz_zero(a2);
                          fmpz_addmul_ui(a2, s1, 2);
                          fmpz_zero(a3);
                          fmpz_submul_ui(a3, s2, 2);
                          fmpz_mul(a3, a3, t1);
                          fmpz_addmul(a3, a2, t2);
                          fmpz_addmul(a3, a1, t4);
                          fmpz_addmul(a3, a0, t5);
                          fmpz_zero(a0);
                          fmpz_addmul_ui(a0, s4, 2);
                          fmpz_zero(a1);
                          fmpz_submul_ui(a1, s5, 2);
                          fmpz_zero(a2);
                          fmpz_submul_ui(a2, s1, 2);
                          fmpz_zero(a4);
                          fmpz_addmul_ui(a4, s2, 2);
                          fmpz_mul(a4, a4, u1);
                          fmpz_addmul(a4, a2, u2);
                          fmpz_addmul(a4, a1, u4);
                          fmpz_addmul(a4, a0, u5);
                          fmpz_zero(a0);
                          fmpz_submul_ui(a0, t4, 2);
                          fmpz_zero(a1);
                          fmpz_addmul_ui(a1, t5, 2);
                          fmpz_zero(a2);
                          fmpz_addmul_ui(a2, t1, 2);
                          fmpz_zero(a8);
                          fmpz_submul_ui(a8, t2, 2);
                          fmpz_mul(a8, a8, u1);
                          fmpz_addmul(a8, a2, u2);
                          fmpz_addmul(a8, a1, u4);
                          fmpz_addmul(a8, a0, u5);
                          ...
                          /* Computation of a0 = (rl_pt ** 8 - 28 * rl_pt ** 6 * im_pt ** 2 + 70 * rl_pt ** 4 * im_pt ** 4 - 28 * rl_pt ** 2 * im_pt ** 6 + im_pt ** 8)  */
